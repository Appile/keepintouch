...
The easiest way to start debugging the application is through the React Native Debugger, an electron app that includes the React Debugger, Redux Dev Tools, and Chrome dev tools.
To install the debugger, run these commands on your mac: 
* `brew update`
